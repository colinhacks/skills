...
#from userapp.models import NewUserProfile


class SendMessageForm(UserCreationForm):
    error_css_class = "error"


    message = forms.ChoiceField(choices=yearChoices)
    ...
    def save(self, commit=False):
        ...
        try:
            ...
            profile = NewUserProfile(user=user)
